...
import { getInquiriesMyListStruct, inquiryCreateSchema, inquiryIdSchema, inquiryUpdateSchema, replyCreateSchema, replyIdSchema, replyUpdateSchema } from '../structs/inquiry.struct';
